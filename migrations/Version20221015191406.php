 ...
 */
final class Version20221015191406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE permission DROP partenaire_id, DROP structure_id, DROP is_active');
        $this->addSql('ALTER TABLE structure DROP id_permission');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE permission ADD partenaire_id INT NOT NULL, ADD structure_id INT NOT NULL, ADD is_active TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE structure ADD id_permission INT NOT NULL');
    }
}
